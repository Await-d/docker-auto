<template>
  <div class="container-stats-widget" :class="{ 'compact-mode': displayMode === 'compact' }">
    <!-- Header Section -->
    <div class="stats-header">
      ...
      <div class="status-summary">
        ...
        <div class="status-item error" v-if="containerData.error > 0">
    ...
    <div class="chart-section" v-if="displayMode !== 'minimal'">
      <div class="chart-container">
        ...
        <div class="donut-chart" ref="chartRef">
        ...
        >
          ...
          <div class="category-stats">
            ...
            <div class="category-status">
              <span class="running-dots" :style="{ width: `${(image.running / image.containers) * 100}%` }"></span>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="registry-section" v-if="displayMode === 'detailed'">
    ...
    <div class="resource-section" v-if="displayMode !== 'minimal'">
        ...
        <el-dropdown @command="handleSortChange">
          ...
          <template #dropdown>
            <el-dropdown-menu>
              ...
              <el-dropdown-item command="memory">Memory Usage</el-dropdown-item>
              <el-dropdown-item command="network">Network I/O</el-dropdown-item>
          ...
          <div class="container-metrics">
            <div class="metric cpu">
              ...
              <div class="metric-bar">
                <div
                  class="metric-fill"
                  :style="{ width: `${Math.min(container.cpu, 100)}%`, backgroundColor: getResourceColor(container.cpu) }"
                ></div>
              </div>
            </div>
            <div class="metric memory">
              <span class="metric-label">RAM</span>
              <span class="metric-value">{{ formatBytes(container.memory) }}</span>
              <div class="metric-bar">
                <div
                  class="metric-fill"
                  :style="{ width: `${Math.min(container.memoryPercent, 100)}%`, backgroundColor: getResourceColor(container.memoryPercent) }"
                ></div>
              </div>
            </div>
          </div>
    ...
    <!-- Quick Actions -->
    <div class="actions-section" v-if="displayMode === 'detailed'">
    ...
    <!-- Health Check Status -->
    <div class="health-section" v-if="containerData.healthChecks && displayMode !== 'minimal'">
    ...
    <!-- Recent Events -->
    <div class="events-section" v-if="displayMode === 'detailed' && containerData.recentEvents">
      <div class="events-header">
        <span class="events-title">Recent Events</span>
        <span class="events-count">{{ containerData.recentEvents.length }}</span>
      </div>
...
import {
  Box, ArrowDown, CaretRight, Delete, View, Warning,
...
const healthySummary = computed(() => {
  const healthy = containerData.value.healthChecks?.filter(h => h.status === 'healthy').length || 0
