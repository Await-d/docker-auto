...
export const updatesAPI = {
  ...
  ): Promise<{ operationId: string; queuedUpdates: number }> {
    return post<{ operationId: string; queuedUpdates: number }>(
      "/api/updates/bulk",
      operation,
    );
  },
  ...
  async scheduleUpdate(
    ...
    return post<ScheduledUpdate>(
      `/api/updates/${updateId}/schedule`,
      scheduleRequest,
    );
  },
  ...
  async applyPolicy(
    ...
    return post<{ applied: number; skipped: number }>(
      `/api/updates/policies/${policyId}/apply`,
      { containerIds },
    );
  },
  ...
  async createTemplate(
    template: Partial<UpdateTemplate>,
  ...
  async updateTemplate(
    ...
    return put<UpdateTemplate>(
      `/api/updates/templates/${templateId}`,
      template,
    );
  },
